...
void export_functional(py::module &m) {
    ...
    py::class_<SuperFunctional, std::shared_ptr<SuperFunctional>>(m, "SuperFunctional", "docstring")
        ...
        .def("x_functionals", py::overload_cast<>(&SuperFunctional::x_functionals), "Returns all X Functionals.")
        .def("c_functionals", py::overload_cast<>(&SuperFunctional::c_functionals), "Returns all C Functionals.")
