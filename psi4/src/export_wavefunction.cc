...
void export_wavefunction(py::module& m) {
    ...
    py::class_<fisapt::FISAPT, std::shared_ptr<fisapt::FISAPT>>(m, "FISAPT", "A Fragment-SAPT Wavefunction")
        ...
        .def("felst_einsums", &fisapt::FISAPT::felst_einsums, "F-SAPT0 electrostatics einsums.")
        .def("fexch_einsums", &fisapt::FISAPT::fexch_einsums, "F-SAPT0 exchange einsums.")
        .def("find_einsums", &fisapt::FISAPT::find_einsums, "F-SAPT0 induction einsums.")
        .def("fdisp_einsums", &fisapt::FISAPT::fdisp_einsums, "F-SAPT0 dispersion einsums.")
